...
{
  // JWM: Why doesn't this work?? Color me confused...
...
void Java_jwmatthys_rtcmix_DroidMix_createEngine(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_jwmatthys_rtcmix_DroidMix_createBufferQueueAudioPlayer(JNIEnv* env,
        jclass clazz)
{
    SLresult result;
...
jboolean Java_jwmatthys_rtcmix_DroidMix_createUriAudioPlayer(JNIEnv* env, jclass clazz,
        jstring uri)
{
    SLresult result;
...
void Java_jwmatthys_rtcmix_DroidMix_setPlayingUriAudioPlayer(JNIEnv* env,
...
void Java_jwmatthys_rtcmix_DroidMix_setLoopingUriAudioPlayer(JNIEnv* env,
...
void Java_jwmatthys_rtcmix_DroidMix_setChannelMuteUriAudioPlayer(JNIEnv* env,
...
void Java_jwmatthys_rtcmix_DroidMix_setChannelSoloUriAudioPlayer(JNIEnv* env,
...
int Java_jwmatthys_rtcmix_DroidMix_getNumChannelsUriAudioPlayer(JNIEnv* env, jclass clazz)
{
    SLuint8 numChannels;
    SLresult result;
    SLMuteSoloItf muteSoloItf = getMuteSolo();
...
void Java_jwmatthys_rtcmix_DroidMix_setVolumeUriAudioPlayer(JNIEnv* env, jclass clazz,
        jint millibel)
{
    SLresult result;
...
void Java_jwmatthys_rtcmix_DroidMix_setMuteUriAudioPlayer(JNIEnv* env, jclass clazz,
        jboolean mute)
{
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
void Java_jwmatthys_rtcmix_DroidMix_enableStereoPositionUriAudioPlayer(JNIEnv* env,
...
void Java_jwmatthys_rtcmix_DroidMix_setStereoPositionUriAudioPlayer(JNIEnv* env,
...
jboolean Java_jwmatthys_rtcmix_DroidMix_enableReverb(JNIEnv* env, jclass clazz,
        jboolean enabled)
{
    SLresult result;
...
jboolean Java_jwmatthys_rtcmix_DroidMix_selectClip(JNIEnv* env, jclass clazz, jint which,
        jint count)
{
    switch (which) {
    case 0:     // CLIP_NONE
...
jboolean Java_jwmatthys_rtcmix_DroidMix_createAssetAudioPlayer(JNIEnv* env, jclass clazz,
...
void Java_jwmatthys_rtcmix_DroidMix_setPlayingAssetAudioPlayer(JNIEnv* env,
        jclass clazz, jboolean isPlaying)
{
    SLresult result;
...
jboolean Java_jwmatthys_rtcmix_DroidMix_createAudioRecorder(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_jwmatthys_rtcmix_DroidMix_startRecording(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_jwmatthys_rtcmix_DroidMix_shutdown(JNIEnv* env, jclass clazz)
{
